...
clippy.Agent.prototype = {
    ...
    play: function(a, b, c) {
        return this.hasAnimation(a) ? (b === undefined && (b = 5e3),
        this._addToQueue(function(d) {
            var e = !1
              , f = function(a, b) {
                b === clippy.Animator.States.EXITED && (e = !0,
                c && c(),
                d())
            };
...
clippy.Animator.prototype = {
    _setupElement: function(a) {
        ...
        a.css({
          //increasing this breaks it for some reason...
            width: b[0],
            height: b[1]
        }),
    ...
    showAnimation: function(a, b) {
        ...
        this.hasAnimation(a) ? (this._currentAnimation = this._data.animations[a],
        this.currentAnimationName = a,
        this._started || (this._step(),
        this._started = !0),
        this._currentFrameIndex = 0,
        this._currentFrame = undefined,
        this._endCallback = b,
...
clippy.Balloon.prototype = {
    ...
    _sayWords: function(a, b, c) {
        ...
        this._addWord = $.proxy(function() {
            if (!this._active)
                return;
            g > d.length ? (this._active = !1,
            this._hold || (c(),
            this.hide())) : (f.text(d.slice(0, g).join(" ")),
            g++,
    ...
    pause: function() {
        window.clearTimeout(this._loop),
        this._hiding && (window.clearTimeout(this._hiding),
        this._hiding = null)
    },
    resume: function() {
...
clippy.BASE_PATH = "static/clippy/agents/",
